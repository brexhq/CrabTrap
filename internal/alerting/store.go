...
// ClaimFlushableDenials atomically deletes and returns buffered denials older
// than batchWait. Uses DELETE ... RETURNING so only one replica can claim each
// row — no advisory lock needed, pgbouncer-compatible.
